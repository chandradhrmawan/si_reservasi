<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Master Barang</span> 
      <span class="label label-important"><i class="icon-arrow-down"></i></span></a>
      <ul>
        <li><a href="kelola_barang.php">Kelola Barang</a></li>
        <li><a href="kelola_kategori.php">Kelola Kategori</a></li>
        <li><a href="kelola_merk.php">Kelola Merk</a></li>
        <li><a href="kelola_warna.php">Kelola Warna</a></li>
        <li><a href="kelola_ukuran.php">Kelola Ukuran</a></li>
      </ul>
    </li>
     <li> <a href="laporan_penyewaan.php"><i class="icon icon-edit"></i> <span>Laporan Penyewaan</span></a> </li>
