          ...
          <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
              ...
              while($r = mysql_fetch_array($sql)){
                ...
                if($lama_telat==0){
                  $denda = 0;
                  $sub_total = $sub_total + ($r['harga_sewa'] * $lama_sewa);
                }else{
                  if($lama_telat = 1){
                    $denda = $sub_total + ($r['harga_sewa'] * $lama_sewa)/2;
                    $sub_total = $sub_total + ($r['harga_sewa'] * $lama_sewa + $denda);
                  }else{
                    $denda = $sub_total + ($r['harga_sewa'] * $lama_sewa);
              ...
              <tr>
                ...
                <td colspan="2">Rp. <?php echo number_format($denda); ?></td>
              </tr>
              <tr>
                <td colspan="4">Dp</td>
