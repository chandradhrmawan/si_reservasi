		...
		<div class="row">
			...
			<table id="example" class="display" width="100%" cellspacing="0">
				...
				<tbody>
					...
					$link = "form_pembatalan.php?id_sewa=$row[id_sewa]";
						...
						<tr>
							<form action="proses_bayar.php" method="POST">
								...
								<td>
									<center><a href="<?php echo $link ?>" title="Form Pembatalan"><button type="button" name="batal" <?php echo $tombol; ?> class="btn btn-sm btn-default"><i class="fa fa-trash"> Pembatalan </i></button> </a></center>
								</td>
							</form>
						</tr>
						<?php $no++; } ?>
